...
public class ItemCustomRepositoryImpl implements ItemCustomRepository {
	...
	@Override
	public List<Item> getItemsByPage(Integer page, ItemCategoryType category) {
	...
	private BooleanExpression isCategory(ItemCategoryType categoryType) {
		if (categoryType == null) {
			return null;
		}

		return item.categoryType.eq(categoryType);
	}
}
